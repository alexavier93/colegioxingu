...
@section('content')
    ...
    <div class="page-header-content py-3">
        ...
        <ol class="breadcrumb mb-0 mt-4">
            ...
            <li class="breadcrumb-item active" aria-current="page">Nova Data</li>
        </ol>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.agenda.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="data" class="form-control" data-toggle="datepicker" value="{{ old('date') }}" required>
                            </div>
                        </div>
