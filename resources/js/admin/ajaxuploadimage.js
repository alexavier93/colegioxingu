var php_upload_path = $('.urlUploadAjaxImage').val()
    ...
    $.extend($.summernote.plugins, {
        ...
        ajaximageupload: function (context) {
                                ...
                                success: function (data) {
                                    ...
                                    if (data.message == 'ok') {
                                        ...
                                        context.invoke(
                                            ...
                                            "<img src='" +
                                                uploadedFile +
                                                "' style='width: 20%; margin: 10px;' alt='uploaded picture' />"
                                        )
                                        self.$panel.hide()
                                        $('body').removeClass(
                                            'ajaxfileupload-overlay'
                                        )
                                    } else {
                                        alert(data.message)
                                    }
            ...
            this.initialize = function () {
                this.$panel = $(
                    '<div class="ajaxfileupload-panel"><div id="ajaxFileUploadInner"><div id="ajaxPanelClose">+</div><div id="fileUploadGroup"><h4>Choose image to upload :</h4><br /><input type="file" id="file" name="file"  /></div><div id="ajaxFileUploadSubmit">Upload</div></div></div>'
                )
                    .css({
                        position: 'absolute',
                        width: 400,
