        ...
        <div class="col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                    <span class="m-0 font-weight-bold text-primary">Agenda de Visitas</span>
                </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($visitas as $visita)
                                ...
                                <tr>
                                    ...
                                    <td width="15%">
                                        <a href="{{ route('admin.visitas.show', ['visita' => $visita->id]) }}" class="btn btn-sm btn-primary">Ver</a>
                                        <a href="javascript:;" data-toggle="modal" data-id='{{ $visita->id }}' data-target="#modalDelete" class="btn btn-sm btn-danger delete">Excluir</a>
                                    </td>
                                </tr>
