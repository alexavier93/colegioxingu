        ...
        <div class="col-xl-12 col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('admin.messages.index') }}" class="btn btn-sm btn-primary mr-1">Voltar</a>
                        <a href="javascript:;" data-toggle="modal" data-id='{{ $message->id }}' data-target="#modalDelete" class="btn btn-sm btn-danger">Excluir</a>
                    </div>
                ...
                <div class="card-body p-5">
                    ...
                    <div class="col-9">
                        ...
                        <span class="font-weight-bold">E-mail: </span><em>{{ $message->email }}</em><br>
                        <span class="font-weight-bold">Assunto: </span><em>{{ $message->subject }}</em><br>
                        <div class="font-weight-bold">Mensagem:</div>
