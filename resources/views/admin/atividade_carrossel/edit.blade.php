...
@section('content')
    ...
    <div class="page-header-content py-3">
        ...
        <ol class="breadcrumb mb-0 mt-4">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.atividades.index') }}">Atividades</a></li>
        ...
        <div class="col-xl-12 col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.atividades.update', ['atividade' => $atividade->id]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="descricao" rows="5" required>{{ $atividade->descricao }}</textarea>
                            </div>
                        </div>
