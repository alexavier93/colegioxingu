...
@section('content')
    ...
    <div class="page-header-content py-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
            <h1 class="h3 mb-0 text-gray-800">{{ $pagina->titulo }}</h1>
        </div>

        <ol class="breadcrumb mb-0 mt-4">
            <li class="breadcrumb-item"><a href="#">Painel Admin</a></li>
            <li class="breadcrumb-item"><a href="{{ route('admin.paginas.index') }}">Páginas</a></li>
        ...
        <div class="col-xl-12 col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.paginas.update', ['pagina' => $pagina->id]) }}" method="post" enctype="multipart/form-data">
